...
// let questionCount = 1; // Start counting from 1 since the first question is already present
...
//                 <input type="text" class="openEndedInput" name="openEndedAnswer" placeholder="Type the correct answer" required>
//             </div>
//         </div>
//     `;
...
//             quizData.questions.push({ text, type: 'multiple', options: { a, b, c, d }, correct });
//         } else {
